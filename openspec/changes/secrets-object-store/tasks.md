...
## 17. Server & CLI: Description Field
...
- [ ] 17.3 Add `--description` to the CLI inject command and surface it wherever object metadata is shown, and verify it round-trips end to end
